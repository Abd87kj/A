...
const ITEMS = {
  ...
  random: {
    id: 'random',
    name: '🎲 عشوائي',
    description: 'تستخدمها في دورك لطرد لاعب عشوائي بدون اختيار',
    price: 100,
    emoji: '🎲',
  },
  nuke: {
...
module.exports = {
  ...
  async handleButton(interaction) {
    ...
    if (interaction.customId.startsWith('shop_buy_')) {
      ...
      if (itemId === 'random')  user.activeRandoms  = (user.activeRandoms  || 0) + 1;
    ...
    if (interaction.customId === 'shop_inventory') {
      ...
      const embed = new EmbedBuilder()
        ...
        .addFields(
          ...
          { name: '🎲 عشوائي', value: `${user.activeRandoms  || 0} قطعة`, inline: true },
...
function buildShopButtons() {
  const buyRow1 = new ActionRowBuilder().addComponents(
    ...
    new ButtonBuilder()
      ...
      .setStyle(ButtonStyle.Secondary),
    new ButtonBuilder()
      .setCustomId('shop_buy_random')
      .setLabel('شراء عشوائي')
      .setEmoji('🎲')
      .setStyle(ButtonStyle.Secondary),
    new ButtonBuilder()
