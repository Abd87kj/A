...
const { getGuildSettings } = require('../utils/mafiaSettings');
...
function buildPlayer(interaction) {
  return {
    ...
    // ⚠️ كان قبل: interaction.user.avatarURL (بدون استدعاء الدالة، ويفقد الـ this لو استُعمل خارج كلاس User)
    // الصحيح: نخزن رابط نصي جاهز مباشرة، بنفس طريقة bomb.js
