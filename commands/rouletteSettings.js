...
const PRESET_THEMES = {
  ...
  // ✅ ثيم كحلي غامق جديد
  navy: [
    { outer: '#0a1628', inner: '#060d18', text: '#7ab0ff' },
    { outer: '#0d1f3e', inner: '#080f20', text: '#90c0ff' },
    { outer: '#091530', inner: '#050b18', text: '#6aa8ff' },
    { outer: '#0c1c38', inner: '#070e1c', text: '#80b8ff' },
    { outer: '#0a1a34', inner: '#060c1a', text: '#70b0ff' },
    { outer: '#0e2244', inner: '#090f22', text: '#98c8ff' },
  ],
};
