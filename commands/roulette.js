...
const { generateWheelImage, generateBannerImage, generateSmoothAngles } = require('../utils/wheelCanvas');
...
module.exports = {
  ...
  async execute(interaction, client) {
    ...
    // أرسل صورة البانر الكحلية أولاً
    let bannerMsg;
    try {
