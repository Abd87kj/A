...
const { generateWheelImage, generateWheelGif, generateBannerImage, generateSmoothAngles, getFrameDelays, getTotalGifDuration } = require('../utils/wheelCanvas');
...
async function startSpin(channel, session, channelId) {
  ...
  const totalGifTime = getTotalGifDuration(48, 3000) + 600;
