...
const { generateWheelImage, generateWheelGif, generateBannerImage, generateSmoothAngles, getFrameDelays } = require('../utils/wheelCanvas');
...
async function startSpin(channel, session, channelId) {
  ...
  // ننتظر وقت الـ GIF تقريباً ثم نعلن النتيجة
  const totalGifTime = 48 * 100;
