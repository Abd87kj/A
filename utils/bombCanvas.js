...
async function generateWordImage({ first, last, holderName, holderAvatarUrl, round, roundSeconds, bannerUrl = null }) {
  ...
  // ── الخلفية ──
  // أولوية: بانر مخصص من إعدادات السيرفر، وإلا الخلفية الزرقاء الافتراضية، وإلا تدرج بديل
  ...
  if (!hasImageBg) {
    // تدرج افتراضي أسود-أحمر (يستخدم فقط إذا تعذر تحميل أي صورة خلفية)
  ...
  // الوقت المتبقي (+ أيقونة مؤقت بدل ⏱️)
  ctx.fillStyle = '#ffcc00';
