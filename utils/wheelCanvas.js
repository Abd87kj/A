...
function generateSmoothAngles(winnerIndex, playerCount, steps = 36) {
...
function getFrameDelays(steps = 36) {
  const delays = [];
  for (let i = 0; i < steps; i++) {
    const t = i / steps;
    if (t < 0.15)      delays.push(55);
    else if (t < 0.50) delays.push(70);
    else if (t < 0.70) delays.push(95);
    else if (t < 0.82) delays.push(140);
    else if (t < 0.90) delays.push(220);
    else if (t < 0.95) delays.push(340);
    else               delays.push(500);
  }
  return delays;
}
