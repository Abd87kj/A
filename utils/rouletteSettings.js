...
const PRESET_THEMES = {
  // 🌊 كحلي غامق + نيون أزرق
  navy: [
    { outer: '#050c18', inner: '#020608', text: '#ffffff', neon: '#2e7dff' },
    { outer: '#070f22', inner: '#030610', text: '#ffffff', neon: '#3a8cff' },
    { outer: '#040a14', inner: '#02050c', text: '#ffffff', neon: '#1e6fff' },
    { outer: '#060e1c', inner: '#030710', text: '#ffffff', neon: '#2e7dff' },
    { outer: '#050b16', inner: '#02060a', text: '#ffffff', neon: '#1e6fff' },
    { outer: '#07102a', inner: '#040814', text: '#ffffff', neon: '#3a8cff' },
  ],
  // 🔴 أحمر غامق + نيون أحمر
  red: [
